...
function convertModelInfoToProtoOpenRouter(info: ModelInfo | undefined): OpenRouterModelInfo | undefined {
	...
	return {
		...
		tiers: info.tiers || [],
		requiresNativeToolCalls: info.requiresNativeToolCalls,
	}
}
...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		planModeUsePromptCache: config.planModeUsePromptCache,
		actModeUsePromptCache: config.actModeUsePromptCache,
		...
		planModeOpenAiApiKey: config.planModeOpenAiApiKey,
		actModeOpenAiApiKey: config.actModeOpenAiApiKey,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		usePromptCache: protoConfig.usePromptCache,
		...
		planModeUsePromptCache: protoConfig.planModeUsePromptCache,
		actModeUsePromptCache: protoConfig.actModeUsePromptCache,
		...
		planModeOpenAiApiKey: protoConfig.planModeOpenAiApiKey,
		actModeOpenAiApiKey: protoConfig.actModeOpenAiApiKey,
